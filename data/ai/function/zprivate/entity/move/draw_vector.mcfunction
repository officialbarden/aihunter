...
scoreboard players operation #ai.speed.X ai.Values *= @n[tag=ai.mannequin,predicate=ai:id,type=mannequin] ai.MovementSpeed
scoreboard players operation #ai.speed.Z ai.Values *= @n[tag=ai.mannequin,predicate=ai:id,type=mannequin] ai.MovementSpeed

execute unless score #ai.speed.Y ai.Values matches ..0 run scoreboard players operation #ai.speed.Y ai.Values = @n[tag=ai.mannequin,predicate=ai:id,type=mannequin] ai.JumpStrength
