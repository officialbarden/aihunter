...
execute positioned ~ ~-1 ~ align xyz if entity @n[type=snowball,tag=astar,tag=!astar.create,tag=!astar.finished,predicate=!astar:is_end,dx=0,dy=2,dz=0] run return run kill @s
