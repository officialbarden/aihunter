...
scoreboard objectives add astar.iterCount dummy
...
# // Prevent it from relying on looping till hitting maxCommandChainLength gamerule
execute unless score maxIterations astar.config matches -2147483648..2147483647 run scoreboard players set maxIterations astar.config 60000